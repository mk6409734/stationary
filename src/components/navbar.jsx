...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex flex-row justify-around border h-16">
        <div className=" relative">
          <img
            src="https://www.sayastationery.com/logo_main.svg"
            className="max-w-32 absolute  -top-6"
            alt="imag"
          ></img>
        </div>
        <div className="">
          <ul className="hidden md:flex mt-5  gap-6 tracking-wide">
            <li className="uppercase hover:border-b-4 border-indigo-500">
              Home
            </li>
            <li className="uppercase hover:border-b-4 border-indigo-500">
              Corporate
      ...
      {show && (
        <div
          class="items-center justify-between  w-full md: md:hidden  md:order-1"
          id="navbar-cta"
        >
